...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~hasnainkk.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, hasnainkk.Client):
                self.add_handler(hasnainkk.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        hasnainkk.handlers.ChosenInlineResultHandler(func, self),
