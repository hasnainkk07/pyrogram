...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~hasnainkk.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, hasnainkk.Client):
                self.add_handler(hasnainkk.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        hasnainkk.handlers.EditedMessageHandler(func, self),
